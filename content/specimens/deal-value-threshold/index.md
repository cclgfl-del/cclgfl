---
title: Deal value thresholds and the acquisitions merger control could not see
...
Merger control in India, as in most jurisdictions, has historically asked whether the parties to a transaction are large, measured by their assets and turnover. That question is well suited to industrial combinations. It is poorly suited to the acquisition of a young technology firm with modest revenue and a large, valuable user base.
...
Everything turns on what counts as substantial business operations in India. The regulations frame the test by reference to users, gross merchandise value and turnover attributable to India, which gives parties a measurable standard — but one that will be tested first in borderline cases, where a target's Indian presence is real but secondary.

- A measurable test is easier to comply with than an open-textured one.
- It is also easier to structure around.
