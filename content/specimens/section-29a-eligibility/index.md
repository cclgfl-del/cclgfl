...
A connected person includes anyone who is a promoter or in the management or control of the resolution applicant, anyone who will be a promoter or in management after implementation of the plan, and the holding company, subsidiary, associate company or related party of either. For diversified groups, that definition can capture entities with no role in the default under examination.

### B. The non-performing asset clause

The NPA ground is the one most often litigated, because it is framed by reference to the classification of an account rather than to the conduct of the applicant. An applicant may be ineligible because a group company's account has been classified as an NPA for a year, even where that account has nothing to do with the corporate debtor being resolved.

## II. The cost to the bidding pool

Every exclusion narrows the field of bidders, and a narrower field tends to mean lower recoveries. The question is therefore not whether section 29A should exist, but whether its breadth is proportionate to the harm it targets.

| Ground of ineligibility | Directed at | Collateral reach |
|---|---|---|
| Wilful defaulter | Conduct of the applicant | Low |
| NPA for one year or more | Classification of an account | High, through connected persons |
| Undischarged insolvent | Status of the applicant | Low |
| Disqualified director | Status of a person in management | Moderate |

Two features of the table matter. The grounds directed at conduct are narrow and defensible. The ground directed at classification is broad, and it is extended further by the definition of connected person.
